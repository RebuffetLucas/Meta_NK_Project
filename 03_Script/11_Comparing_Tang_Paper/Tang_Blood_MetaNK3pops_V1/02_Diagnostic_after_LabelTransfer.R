...
#Re-inject UMAP coordinates in data.query THIS part is a real problem

Cells_DataQuery = Cells(data.query)
Cells_DataQuery = str_sub(Cells_DataQuery , 6,-1)
PBMC_Blood_All_subs_data_query = subset(PBMC_Blood_All, cells= Cells_DataQuery)
PBMC_Blood_All_subs_data_query$predicted.id = data.query$predicted.id #### THIS LINE IS A REAL PROBLEM !!!!!
