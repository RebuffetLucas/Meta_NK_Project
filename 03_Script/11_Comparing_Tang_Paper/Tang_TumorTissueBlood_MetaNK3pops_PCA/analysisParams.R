...
SUB_ANALYSIS_STEP_NAME= "Tang_TumorTissueBlood_MetaNK3pops_PCA"
...
LITERAL_TITLE = "PCA across cancers Seurat_Transfer applied on all Blood Meta NK, Blood Tang, Tumor and tissue NK cells from Tang, here we use 3 pops of NK cells (NK1 , NK2,  NK3 since NKint are considered as NK1 cells)
...
my_colourPheatmap = list(Tissue = c("Blood" = "#DF6589FF", "Tumor" = "#3C1053FF"),
                          #Patho = c("") ,
                         Cluster = c('NK1'='#F8766D','NK3'='#0CB702',
                                     'NK2'='#8494FF')
)
...
NUMBER_VAR_BARPLOTS_PCA_COMPO = 30


PCA_PLOT_POINT_SIZE = 2
PCA_PLOT_TEXT_SIZE = 2
