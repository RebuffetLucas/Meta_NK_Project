...
Markers_Seurat= readRDS("/mnt/DOSI/SUEVLAB/BIOINFO/BIOINFO_PROJECT/Meta_NK2/FromJanine/01_Reference/02_MonitoredGenesList/Malmberg_TOP10.rds")

Markers_Seurat= readRDS("/mnt/DOSI/SUEVLAB/BIOINFO/BIOINFO_PROJECT/Meta_NK5/05_Output/01_GlobalHeterogeneity/Analysis_V2Chem/VF1/DEG/Top20_Different_Levels/All_Markers_NK2AB3.rds")
...
SUBSET = c("CD56dimCD16hi-c1-IL32"  , "CD56dimCD16hi-c2-CX3CR1", "CD56dimCD16hi-c3-ZNF90",  "CD56dimCD16hi-c4-NFKBIA" ,"CD56dimCD16hi-c8-KLRC2" ,
           "CD56brightCD16lo-c1-GZMH" ,"CD56brightCD16lo-c2-IL7R-RGS1lo", "CD56brightCD16lo-c3-CCL3", "CD56brightCD16lo-c4-IL7R")

SUBSET = c("CD56dimCD16hi-c1-IL32"  , "CD56dimCD16hi-c8-KLRC2" ,
           "CD56brightCD16lo-c1-GZMH" )


levels(PBMC$Majortype)
...
table = PBMC@meta.data[,c( "seurat_clusters" , paste0(names(MONITORED_Markers),1) )]
...
VlnPlot(PBMC , features = c("CXCR4", "XCL1", "XCL2", "SELL", "FCER1G"), pt.size = 0, group.by = "seurat_clusters")
