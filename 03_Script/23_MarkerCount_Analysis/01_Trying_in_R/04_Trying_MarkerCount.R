...
saveRDS(data_integrated, "/mnt/DOSI/EVLAB/BIOINFO/BIOINFO_PROJECT/Meta_NK5/05_Output/11_Comparing_Tang_Paper/Tang_Cancer_MetaNK_V3/data.integrated_MetaNKref.rds")
...
X_ref = adata_ref@assays[["RNA"]]@counts  # rows: cell, cols: genes
cell_type_ref = adata_ref@meta.data[["FirstClust"]]

X_test = adata_test@assays[["RNA"]]@counts  # rows: cell, cols: genes
