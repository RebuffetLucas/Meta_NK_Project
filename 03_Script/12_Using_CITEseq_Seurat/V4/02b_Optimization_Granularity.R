...
Seurat_NK_Final =readRDS("/mnt/DOSI/SUEVLAB/BIOINFO/BIOINFO_PROJECT/Meta_NK5/05_Output/12_CITEseq_Analysis/Final_After_Satija_Procedure_D0ref_D3_D7.rds")
...
DimPlot(PBMC_Sabrina, reduction = "wnn.umap", group.by = "wsnn_res.0.2", label = TRUE, label.size = )

DimPlot(PBMC_Sabrina, reduction = "wnn.umap", group.by = "wsnn_res.0.7")
DimPlot(PBMC_Sabrina, reduction = "wnn.umap", group.by = "wsnn_res.1.2", pt.size = 1.8 )

#rename in original object
Seurat_NK_Final$seurat_clusters  = PBMC_Sabrina$wsnn_res.0.2

Seurat_NK_Final = SetIdent(Seurat_NK_Final, value= "seurat_clusters")
saveRDS(Seurat_NK_Final, "/mnt/DOSI/SUEVLAB/BIOINFO/BIOINFO_PROJECT/Meta_NK5/05_Output/12_CITEseq_Analysis/Final_After_Satija_Procedure_D0ref_D3_D7_Optimized.rds")
