...
read_chunk( path=file.path( WORKING_DIR, "01a_TransferOfLabel_Harmony.R"));
read_chunk( path=file.path( WORKING_DIR, "02_Diagnostic_after_Harmonization.R"));
```
...
```{r rmd_dataLoad, warning = TRUE, fig.dim = c(20,10)}
<<TransferLabelHarmony>>
```

```{r rmd_Diagnostic, warning = TRUE, fig.dim = c(30,10)}
<<DiagnosticAfterHarmony>>
```
