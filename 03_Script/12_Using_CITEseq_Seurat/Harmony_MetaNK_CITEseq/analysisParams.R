...
SUB_ANALYSIS_STEP_NAME= "Tang_Cancer_MetaNK"
...
LITERAL_TITLE = "Harmony Batch Correction with Tang Data to assess PBMC composition in different cancers according to MetaNK"
...
#"VARIABLE_FEATURE_INTEGRATION_FEATURES" =  Select Integration features 
...
HARMO_USE_REF = FALSE #True or false , WHether to use a reference during Harmony Integration
