...
PBMC= readRDS("/mnt/DOSI/SUEVLAB/BIOINFO/BIOINFO_PROJECT/Meta_NK5/05_Output/16_SCTonOurDAta/SCT_rPCA_V2only.rds")

Merged_Seurat_Rescaled = PBMC
...
DimPlot(Merged_Seurat_Rescaled, reduction = "umap", group.by = "FirstClust")
...
saveRDS(All_Markers, "/mnt/DOSI/SUEVLAB/BIOINFO/BIOINFO_PROJECT/Meta_NK5/05_Output/16_SCTonOurDAta/DEG/All_Markers_12clusters.rds")
