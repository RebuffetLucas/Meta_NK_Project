...
set.seed(SEED)
PBMC_Meta_NK_V2= SetIdent(PBMC_Meta_NK_V2, value = "orig.ident")

#Downsample randomly (or not)
if(SUBSET_DOWNSAMPLE_QUERY==TRUE){
PBMC_Blood_subset = subset(PBMC_Meta_NK_V2, downsample = N_DOWNSAMPLE_QUERY_PER_IDENT)
}
