...
Merged_Seurat_Rescaled <- RunUMAP(Merged_Seurat_Rescaled, reduction = "pca", dims= 1:30, reduction.name = "UMAP", reduction.key = "UMAP")
#Merged_Seurat_Rescaled <- RunUMAP(Merged_Seurat_Rescaled,  reduction.name = "UMAP", reduction.key = "UMAP")

Merged_Seurat_Rescaled <- FindNeighbors(Merged_Seurat_Rescaled, reduction = "pca", dims= 1:30)
Merged_Seurat_Rescaled <- FindClusters(Merged_Seurat_Rescaled, resolution = 1, random.seed = SEED )
...
Merged_Seurat_Rescaled = subset(Merged_Seurat_Rescaled , idents= c("0", "1", "2", "3", "4", "5", "6", "7")) 
