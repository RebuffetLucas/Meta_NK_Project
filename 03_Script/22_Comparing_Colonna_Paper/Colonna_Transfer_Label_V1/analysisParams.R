...
SUB_ANALYSIS_STEP_NAME= "Colonna_Transfer_Label_V1"
...
LITERAL_TITLE = "Classical Process for label Seurat_Transfer applied on all Colonna's samples, tissue NK cells from Colonna, here we use 3 pops of NK cells (NK1 , NK2,  NK3 since NKint are considered as NK1 cells)
...
QUERY_RDS_NAME = "data.query_all_cells_Healthy_Tissues_Colonna.rds"
DATA_QUERY_SAVE_PATH = file.path(PATH_ANALYSIS_OUTPUT, QUERY_RDS_NAME ) 

REF_RDS_NAME =  "data.ref_all_cells_.rds"
