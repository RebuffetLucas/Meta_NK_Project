...
PBMC_Blood_All = readRDS(paste0(PATH_ANALYSIS_OUTPUT,"/Seurat_Objects/NKcellsfrom4tissues.rds"))
...
#saveRDS(List_query, "/mnt/DOSI/EVLAB/BIOINFO/BIOINFO_PROJECT/Meta_NK5/05_Output/22_Comparing_Colonna_paper/Colonna_Transfer_Label_V1/query_Before_Mapping.rds")
...
saveRDS(List_query, file=paste0(PATH_ANALYSIS_OUTPUT,"/List_query_IterativelyGenerated_after_Mapping.rds"))
